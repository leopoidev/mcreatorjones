...
package net.mcreator.jonemodv.world.biome;
...
import net.mcreator.jonemodv.block.IrBlock;
import net.mcreator.jonemodv.JoneModVModElements;

@JoneModVModElements.ModElement.Tag
public class HhhhhhhhhhhhhhhhBiome extends JoneModVModElements.ModElement {
	public static Biome biome;
	public HhhhhhhhhhhhhhhhBiome(JoneModVModElements instance) {
		super(instance, 53);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(IrBlock.block.getDefaultState(),
				...
				event.getRegistry().register(biome.setRegistryName("jone_mod_v:hhhhhhhhhhhhhhhh"));
			}
		}
	}
	@Override

...
public class ThebowItem extends JoneModVModElements.ModElement {

	@ObjectHolder("jone_mod_v:thebow")
	public static final Item block = null;

	@ObjectHolder("jone_mod_v:entitybulletthebow")
	public static final EntityType arrow = null;

	public ThebowItem(JoneModVModElements instance) {
		super(instance, 45);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletthebow").setRegistryName("entitybulletthebow"));
	}
	...
	public static class ItemRanged extends Item {
		...
		public ItemRanged() {
			super(new Item.Properties().group(ItemGroup.COMBAT).maxDamage(384));

			setRegistryName("thebow");
		}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						...
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 1f, 5, 7);
	...
	public static ArrowCustomEntity shoot(World world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		...
		world.playSound((PlayerEntity) null, (double) x, (double) y, (double) z,
				(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.creeper.hurt")),

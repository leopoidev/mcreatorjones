...
public class TropicalbiomeBlock extends JoneModVModElements.ModElement {
	@ObjectHolder("jone_mod_v:tropicalbiome")
	public static final Block block = null;
	public TropicalbiomeBlock(JoneModVModElements instance) {
		super(instance, 36);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(1.05f, 10f).setLightLevel(s -> 0));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.SOUTH));
			setRegistryName("tropicalbiome");
		}

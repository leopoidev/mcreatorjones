...
import net.mcreator.jonemodv.procedures.Weedstage1UpdateTickProcedure;
...
public class Weedstage1Block extends JoneModVModElements.ModElement {
	@ObjectHolder("jone_mod_v:weedstage_1")
	public static final Block block = null;
	public Weedstage1Block(JoneModVModElements instance) {
		super(instance, 2);
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				Weedstage1UpdateTickProcedure.executeProcedure($_dependencies);
			}
		}
	}
}

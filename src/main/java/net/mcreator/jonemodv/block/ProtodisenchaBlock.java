...
public class ProtodisenchaBlock extends JoneModVModElements.ModElement {

	@ObjectHolder("jone_mod_v:protodisencha")
	public static final Block block = null;

	public ProtodisenchaBlock(JoneModVModElements instance) {
		super(instance, 15);

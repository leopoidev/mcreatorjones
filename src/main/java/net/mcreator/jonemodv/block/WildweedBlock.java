...
public class WildweedBlock extends JoneModVModElements.ModElement {
	@ObjectHolder("jone_mod_v:wildweed")
	public static final Block block = null;
	public WildweedBlock(JoneModVModElements instance) {
		super(instance, 1);

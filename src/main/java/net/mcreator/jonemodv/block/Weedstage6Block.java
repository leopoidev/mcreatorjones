...
public class Weedstage6Block extends JoneModVModElements.ModElement {
	@ObjectHolder("jone_mod_v:weedstage_6")
	public static final Block block = null;
	public Weedstage6Block(JoneModVModElements instance) {
		super(instance, 8);
